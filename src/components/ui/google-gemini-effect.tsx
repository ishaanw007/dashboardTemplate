...
export const GoogleGeminiEffect = ({
    ...
    return (
        <div className={cn("sticky  top-48 md:top-60", className)}>


            <p className=" w-3/4  mx-auto text-3xl md:text-4xl lg:text-6xl font-bold pb-4 text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-400 to-neutral-700">
                {title || `TimekeeperX, an AI-Driven HRM'S`}
            </p>
            <p className=" w-3/4 text-sm md:text-xl font-medium text-center text-neutral-500 mt-4 max-w-lg mx-auto">
                {description ||
                    `Scroll and View all details of Employee
        works!`}
            </p>
            <div className="w-full h-[890px] -top-60 md:-top-40  flex items-center justify-center bg-red-transparent absolute ">
                <button className=" flex flex-col gap-2 font-bold bg-white rounded-full md:px-4 md:py-2 px-2 py-1 md:mt-24 mt-8 z-30 md:text-base text-black text-xs  w-fit mx-auto ">
                    <Image src={lightThemeLogo} className=" w-[140px] h-auto" alt="Logo" />
                    {/* TimeKeeperX */}
                </button>
            </div>
            <svg
